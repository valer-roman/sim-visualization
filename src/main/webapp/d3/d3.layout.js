...
d3.layout.force = function() {
  ...
  function dragup() {
    ...
    if (d3_layout_forceDragMoved) {
      ...
      dragmove(); //move back to where commented for original behaviour
    }

    //dragmove(); //FIXME fix from http://groups.google.com/group/d3-js/browse_thread/thread/a8942e097d598633/fd41932a8c467526?#fd41932a8c467526
    d3_layout_forceDragNode.fixed = false;
    d3_layout_forceDragNode = d3_layout_forceDragElement = null;
  }
